...
const CARD_DEFS = [
  ...
  { name: "Gremlin", cost: 2, attack: 2, health: 3, type: "villain",
    _spawnOnly: true,
    abilities: [],
    desc: "Cannot be played — only spawned. Swarm: +1 ATK for each other Gremlin on the field. (Spawned by Gizmo and Stripe.)" },
  { name: "Stripe", cost: 3, attack: 3, health: 3, type: "villain",
    abilities: [],
    desc: "Jump: When either player takes hero damage, Stripe glows — play for free into any open lane. While Active: When Stripe kills an enemy, spawn a Gremlin (Swarm) in any open lane." },
