...
const CARD_DEFS = [
  ...
  { name: "The Bathroom", cost: 2, attack: 0, health: 1, type: "environment",
    ...
    _spawnOnly: true,
    abilities: [],
    desc: "While Active: The first enemy card to enter this lane is chained — it takes (−2/−2) and can never leave this lane. (Placed only by Jigsaw.)" },
  { name: "The Reveal", cost: 2, attack: 0, health: 1, type: "environment",
    isEnvironment: true,
    _spawnOnly: true,
    abilities: [],
    desc: "While Active: The first card to die in this lane rises on your side as a (1/1). The Reveal is then spent. (Placed only by Jigsaw.)" },
