...
const CARD_DEFS = [
  ...
  { name: "Freddy Krueger", cost: 2, attack: 1, health: 4, type: "villain",
    _spawnOnly: true,
    abilities: [],
    desc: "PASSIVE: Slash a random card in the enemy's hand instead of the opposing lane." },
  ...
  { name: "Apocalypse", cost: 7, attack: 5, health: 6, type: "villain",
    abilities: [],
    desc: "When Played: Every card in your hand (cost ≤ 9) permanently gains a random keyword — Armor 1, Evade 1, Bullseye, or Overdrive. While Active: At the start of each round, a random enemy on the field permanently loses 1 ATK." },
  ...
  { name: "Yoda", cost: 8, attack: 4, health: 5, type: "hero",
    abilities: ["Immunity"],
    desc: "ON PLAY: Choose 2 allies. They strike their lanes using their combined ATK. Splash applies normally. PASSIVE: Allies and your hero take half damage (rounded up). Whenever an ally deals direct hero damage, a random ally gains Armor 1, Evade 1, or Bullseye." },
