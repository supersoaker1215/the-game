...
const CARD_DEFS = [
  ...
  { name: "Ant-Man", cost: 1, attack: 2, health: 1, type: "hero",
    abilities: [],
    desc: "When Played: Summon a (1/1) Ant with Bullseye and Evade 1 in any lane. Destroy an enemy with ≤ 1 ATK or ≤ 1 HP." },
  ...
  { name: "Mr. Fantastic", cost: 1, attack: 0, health: 0, type: "hero",
    abilities: [],
    desc: "When Discarded: The next card you draw costs 2 less." },
  ...
  { name: "Catwoman", cost: 2, attack: 0, health: 0, type: "villain",
    abilities: [],
    desc: "When Discarded: Steal 1 Energy from the opponent next turn." },
  ...
  { name: "Juggernaut", cost: 2, attack: 2, health: 4, type: "hero",
    ...
    desc: "While Active: Allies cannot be Mind Controlled." },
  ...
  { name: "Cyborg", cost: 4, attack: 1, health: 2, type: "hero",
    abilities: [],
  ...
  { name: "Jason Voorhees", cost: 4, attack: 2, health: 3, type: "villain",
    abilities: ["Hunt", "Overdrive", "Revive 1"],
    desc: "Jump: When any ally dies, Jason glows — play for free. When Destroyed: Revive with (+2/+2)." },
  ...
  { name: "The Grinch", cost: 4, attack: 1, health: 2, type: "villain",
    abilities: [],
  ...
  { name: "Captain America", cost: 5, attack: 3, health: 4, type: "hero",
    abilities: ["Armor 1"],
    desc: "When Played: Give an ally Invincible 1. While Active: All cards in your hand cost 1 less Energy. Your attack chains (ATK−1) to an adjacent enemy." },
  ...
  { name: "Michael Myers", cost: 4, attack: 3, health: 5, type: "villain",
    abilities: ["Overdrive"],
  ...
  { name: "Homelander", cost: 5, attack: 5, health: 6, type: "villain",
    abilities: [],
    desc: "When Played: Choose to sacrifice an ally — deal damage to an enemy equal to that ally's cost. (Skip the sacrifice if you'd rather not.)" },
  ...
  { name: "Silver Surfer", cost: 7, attack: 6, health: 6, type: "hero",
    abilities: [],
  ...
  { name: "Darth Vader", cost: 8, attack: 6, health: 7, type: "villain",
    abilities: ["Armor 1"],
    desc: "When Played: Move an enemy to an empty lane. Fear 1 an enemy. Then start a 7-damage chain — pick direction each step; damage decreases by 1 per hit. Chain stops at Evade, Invincible, or Armor." },
  { name: "Emperor Palpatine", cost: 8, attack: 6, health: 8, type: "villain",
    abilities: ["Unresistible"],
    desc: "When Played: Chain Freeze 1 consecutive enemies. While Active: Frozen enemies take double damage. When Destroyed: Chain Freeze 1 consecutive enemies." },
  ...
  { name: "Dr. Manhattan", cost: 10, attack: 8, health: 10, type: "hero",
    ...
    desc: "When Played: Heal yourself for 7. While Active: Add 3 extra Energy each round." },
