...
const CARD_DEFS = [
  ...
  { name: "Han Solo", cost: 5, attack: 3, health: 4, type: "hero",
    abilities: [],
    desc: "When Played: Choose any lane with an enemy card to attack this combat instead of your own lane (you may stay). While Active: At the start of each round, every ally has a 50% chance to gain Critical — Critical cards deal double damage that round only." },
  ...
  { name: "Yoda", cost: 8, attack: 4, health: 5, type: "hero",
    abilities: ["Immunity"],
    desc: "ON PLAY: Choose 2 allies. They strike their lanes using their combined ATK. Splash applies normally. Cleanse all ally debuffs. PASSIVE: Allies and your hero take half damage (rounded up). Whenever an ally deals direct hero damage, a random ally gains Armor 1, Evade 1, or Bullseye." },
